...
@implementation SNSCompanyResponse
...
+ (NSValueTransformer *)companysJSONTransformer
{
    return [MTLJSONAdapter arrayTransformerWithModelClass:SNSCompany.class];
}
